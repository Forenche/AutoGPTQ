...
void vecquant2matmul_cuda_old(
  ...
  AT_DISPATCH_FLOATING_TYPES(
    vec.scalar_type(), "vecquant2matmul_cuda_old", ([&] {
...
void vecquant3matmul_cuda_old(
  ...
  AT_DISPATCH_FLOATING_TYPES(
    vec.scalar_type(), "vecquant3matmul_cuda_old", ([&] {
...
void vecquant4matmul_cuda_old(
  ...
  AT_DISPATCH_FLOATING_TYPES(
    vec.scalar_type(), "vecquant4matmul_cuda_old", ([&] {
...
void vecquant8matmul_cuda_old(
  ...
  AT_DISPATCH_FLOATING_TYPES(
    vec.scalar_type(), "vecquant8matmul_cuda_old", ([&] {
